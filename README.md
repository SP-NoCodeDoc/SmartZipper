...
**Free for personal use.** Use it for your own files, projects, learning, or non-commercial purposes without restriction.

**Commercial use requires a license.** If you use SmartZipper in a business, organization, or for-profit context, please purchase a commercial license. Contact [support@nocodedoc.com](mailto:support@nocodedoc.com) for pricing.
